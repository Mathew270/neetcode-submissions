...
another thing to note is how recursion works
there was no need to store dfs.left and dfs.right in a dp{} dictionary

initial wrong thinking was that once bottom was computed and we go back to upper nodes
the upper nodes would call .left and .right

but the fact that we went to the bottom nodes and computed means that .left and .right
were already called and are the very reason that we reached the bottom nodes

there was no recomputation of .left and .right meaning no dictionary needed

this is obvious but forgot at the time. remember basics.
"""
